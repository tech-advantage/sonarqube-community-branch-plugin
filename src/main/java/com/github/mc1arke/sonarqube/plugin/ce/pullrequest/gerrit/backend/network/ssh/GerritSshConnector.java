package com.github.mc1arke.sonarqube.plugin.ce.pullrequest.gerrit.backend.network.ssh;

import com.github.mc1arke.sonarqube.plugin.ce.pullrequest.gerrit.GerritConfiguration;
...
public class GerritSshConnector implements GerritConnector {
    ...
    private static final String CMD_LIST_FILES = "backend query --format=JSON --files --current-patch-set -- status:open change:%s limit:1";
    private static final String CMD_SET_REVIEW = "backend review %s -j";
