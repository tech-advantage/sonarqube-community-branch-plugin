...
public class GerritRestConnector implements GerritConnector {
    ...
    private CloseableHttpResponse logAndExecute(HttpRequestBase request) throws IOException {
    ...
    private String consumeAndLogEntity(CloseableHttpResponse response) throws IOException {
